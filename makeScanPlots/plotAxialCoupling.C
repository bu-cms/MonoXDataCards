...
static float minCoupling_spline = 0.02;
...
void plotAxialCoupling(string outputDIR, bool useDMMass = false, float medOverDM = 3, bool useSplineND = true, string energy = "13") {
