...
void plotVectorCoupling(string outputDIR, bool isFull2DGrid = false, bool useDMMass = false, float medOverDM = 3, string energy = "13") {
  ...
  string inputFileName6 = "LimitsForPaperCoupling/higgsCombine_COMB_Vector_gq_0p1.root";
  string inputFileName7 = "LimitsForPaperCoupling/higgsCombine_COMB_Vector_gq_0p05.root";
  string inputFileName8 = "LimitsForPaperCoupling/higgsCombine_COMB_Vector_gq_0p01.root";
